...
void Orc::setCHP(int value) {
    Enemy::setCHP(value);
}

Orc::Orc(Cell *c) : Enemy{c, SYMBOL} {
    Enemy::setMHP(180);
    Enemy::setCHP(180);
    Enemy::setAtk(30);
    Enemy::setDef(25);
}
void Orc::defendFrom(Shade *sPlayer) {
    int damage =
...
void Orc::defendFrom(Drow *dPlayer) {
    int damage =
...
void Orc::defendFrom(Vampire *vPlayer) {
    int damage =
...
void Orc::defendFrom(Troll *tPlayer) {
    int damage =
...
void Orc::defendFrom(Goblin *gPlayer) {
    int damage =
